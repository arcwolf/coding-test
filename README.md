...
| 번호 | 파일 | 문제 제목 | 분류 |
|------|------|-----------|------|
| 1000 | [io-1000.py](io-1000.py) | A+B | 기본 입출력 |
| 1001 | [io-1001.py](io-1001.py) | A-B | 기본 입출력 |
| 1032 | [string-1032.py](string-1032.py) | 명령 프롬프트 | 문자열 |
| 1037 | [math-1037.py](math-1037.py) | 약수 | 수학 |
| 1080 | [greedy-1080.py](greedy-1080.py) | 행렬 | 그리디 |
| 1110 | [simulation-1110.py](simulation-1110.py) | 더하기 사이클 | 시뮬레이션 |
| 1145 | [bruteforce-1145.py](bruteforce-1145.py) | 적어도 대부분의 배수 | 완전탐색 / 수학 |
| 1157 | [string-1157.py](string-1157.py) | 단어 공부 | 문자열 |
| 1236 | [greedy-1236.py](greedy-1236.py) | 성 지키기 | 그리디 |
| 1259 | [string-1259.py](string-1259.py) | 팰린드롬수 | 문자열 |
| 1292 | [implementation-1292.py](implementation-1292.py) | 쉽게 푸는 문제 | 수열 / 구현 |
